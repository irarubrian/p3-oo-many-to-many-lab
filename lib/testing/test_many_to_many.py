...
def test_contract_init():
    ...
    date = '01/01/2001'
    royalties = 40000
    contract = Contract(author, book, date)
...
def test_author_has_contracts():
    ...
    author = Author("Name")
    book = Book("Title")
    contract = Contract(author, book, '01/01/2001')
...
def test_author_has_books():
    ...
    author = Author("Name")
    book = Book("Title")
    Contract(author, book, '01/01/2001')
...
def test_author_has_total_royalties():
    ...
    Contract(author, book1, "01/01/2001")
    Contract(author, book2, "01/01/2001")
    Contract(author, book3, "01/01/2001")
...
def test_contract_contracts_by_date():
    ...
    book4 = Book("Title 4")
    contract1 = Contract(author1, book1, "02/01/2001")
    contract2 = Contract(author1, book2, "01/01/2001")
    contract3 = Contract(author1, book3, "03/01/2001")
    contract4 = Contract(author2, book4, "01/01/2001")
